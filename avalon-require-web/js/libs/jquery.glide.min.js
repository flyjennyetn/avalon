...
!
    function(a, b, c, d) {
        ...
        e.prototype.build = function() {
            this.bindings(),
            this.slides.length > 1 && (this.options.circular && this.circular(), this.options.arrows && this.arrows(), this.options.navigation && this.navigation()),
                this.events()
        },
            ...
            e.prototype.slide = function(b, c, d) {
                ...
                this.options.circular && (j -= this.slides.spread, (i || h) && this.disableEvents(), i && (j = this.slides.spread * (g - 2)), h && (j = 0)),
                ...
                this.options.navigation && this.navigation.wrapper && a("." + this.options.navigationClass, this.options.navigation === !0 ? this.parent: this.options.navigation).children().eq( - f).addClass(this.options.navigationCurrentItemClass).siblings().removeClass(this.options.navigationCurrentItemClass),
                    this.currentSlide = f,
            ...
            e.prototype.destroy = function() {
                this.parent.unbind(),
                    ...
                    a(this.navigation.wrapper).children().unbind(),
                    a(this.arrows.wrapper).children().unbind(),
                    this.slide(0, !0),
                    this.pause(),
                this.options.circular && (this.firstClone.remove(), this.lastClone.remove())
            },
            ...
            e.prototype.css = {
                isSupported: function(a) {
                    ...
                    if (a = a.toLowerCase(), g.style[a] !== d && (e = !0), e === !1) {
                        ...
                        for (var i = 0; i < f.length; i++) if (g.style[f[i] + h] !== d) {
                            e = !0;
                            break
                        }
                    }
