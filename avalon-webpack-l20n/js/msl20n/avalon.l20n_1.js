 ...
 */
define(["./l20n/l20n", "./l20n/l20n/intl", "./l20n/l20n/platform/io", "avalon", "./meld"], function (mzl20n, Intl, io, avalon, meld) {
    'use strict';
    ...
    avalon.directive('l20n', {
        init: function (data) {
            ...
            update: function(val){
                ...
                data.msl20n.ctx.localizeNode(objparam.key, this.element)
            }
        });
    }else{
        //如果支持1.4,那么将之前的代码抄一下
